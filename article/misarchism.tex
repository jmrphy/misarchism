...
support for the Tea Party is not an artifact of parametric modeling assumptions. Our findings have important
...
To guard against parametric model dependence, we employ matching to
...
also report sensitivity bounds as developed by Rosenbaum (1988).
...
artifact of parametric model dependence and
...
to be model dependent and, as with the estimated effect of moral statism,
would require a fairly large unobserved source of bias to become
insignificant.
