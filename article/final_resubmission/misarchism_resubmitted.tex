...
traditional attitudes are correlated with Factor 2 (clustered in the
bottom-right). Attitudes toward traditional government interventions in
society are positively correlated with Factor 1. Factor 1, which appears
...
explains 14\%. \emph{Morals} and \emph{Immigration} are weakly negatively correlated with the
...
dimension distinct from anti-governmentalism, suggesting that the
...
factor. Figure 2 reveals a few points of interest. First, \emph{Moral
...
illustration is most appropriate. Figure 3 plots the expected effect of
...
visualization. Figure 4 is identical to Figure 3 but now reflects Model
...
\begin{figure}[htbp]
\centering
\includegraphics[width=9.5cm, height=9.5cm]{figures/factorplot-1.pdf}
...
\centering
\includegraphics[width=11.5cm, height=11.5cm]{figures/exploratoryplot-1.pdf}
...
\caption{The Effect of Moral Statism Conditional on Governmentalism (Gov)}
...
\caption{The Effect of Moral Statism Conditional on Governmentalism (Gov) for Conservatives Only}
\end{figure}
