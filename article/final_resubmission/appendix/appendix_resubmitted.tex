...
\item
Correlation Plot for Variables Included in Factor Model
\item
...
\item
 Alternative Dependent Variables for Model 2 (Party ID and Conservatism)
 \item
 Including Ideology in Factor Model and Removing from Regression Model
\item
...
\subsubsection{Additional Information on Factor Analysis}
...
All other variables had probabilities of inclusion less than 50\%.
...
\emph{Governmentalism} and the interaction term
remain signed as in Model 2 with high statistical significance (-.86, p\textless{}.00; -.85, p\textless{}.00,
